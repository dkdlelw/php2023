...
<head>
    ...
    <title>search ID Save - Email</title>
...
<?php
    ...
    $searchEmail = $_POST['youEmail'];
    // echo $searchEmail;
    // ID 조회 쿼리
    $sql = "SELECT youID FROM yungyangMember WHERE youEmail = '$searchEmail'";
                    ...
                    <?php
                        if ($result) {
                            ...
                            if ($count > 0) {
                                ...
                                <fieldset>
                                    <button type="submit" class="login__button btnStyle3">회원가입하러 가기</button>
                                </fieldset>
                                </form>
                                <?php
                            }
